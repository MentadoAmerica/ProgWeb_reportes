...
class DetalleDiario extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            // Campos que vienen del formulario y son obligatorios
            ...
            // Los siguientes campos NO son required porque se asignan automáticamente en el controlador o se calculan
            ...
            // Resto de reglas (tipos de datos, etc.)
    ...
    /**
     * {@inheritdoc}
     * Excluye las columnas generadas por la base de datos (total_km, anio, mes, dia)
     * para que no se incluyan en las sentencias INSERT/UPDATE.
     */
