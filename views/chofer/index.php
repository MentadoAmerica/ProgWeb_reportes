        ...
        <div style="display: flex; gap: 10px; align-items: center;">
            ...
            <div class="dropdown">
                <button class="btn dropdown-toggle" type="button" id="sortDropdown" data-bs-toggle="dropdown" aria-expanded="false" 
                    ...
                    <?php
                    $sortLabels = [
                        'id_chofer' => 'ID (Menor a Mayor)',
                        '-id_chofer' => 'ID (Mayor a Menor)',
                        'nombre_chofer' => 'Nombre (A-Z)',
                        '-nombre_chofer' => 'Nombre (Z-A)',
                    ];
                ...
                <ul class="dropdown-menu" aria-labelledby="sortDropdown" style="border-radius: 12px; border: 1px solid #f0e0d0; box-shadow: 0 6px 16px rgba(98, 17, 50, 0.12); padding: 8px 0; min-width: 200px;">
                    ...
                    <li><?= Html::a('<i class="fas fa-arrow-up" style="margin-right: 10px; width: 16px;"></i>Menor a Mayor', ['index', 'sort' => 'id_chofer'] + Yii::$app->request->queryParams, ['class' => 'dropdown-item' . ($currentSort == 'id_chofer' ? ' active' : ''), 'style' => 'padding: 8px 16px; font-family: "Varela Round", sans-serif;']) ?></li>
                    <li><?= Html::a('<i class="fas fa-arrow-down" style="margin-right: 10px; width: 16px;"></i>Mayor a Menor', ['index', 'sort' => '-id_chofer'] + Yii::$app->request->queryParams, ['class' => 'dropdown-item' . ($currentSort == '-id_chofer' ? ' active' : ''), 'style' => 'padding: 8px 16px; font-family: "Varela Round", sans-serif;']) ?></li>
                    ...
                    <li><?= Html::a('<i class="fas fa-arrow-up" style="margin-right: 10px; width: 16px;"></i>A - Z', ['index', 'sort' => 'nombre_chofer'] + Yii::$app->request->queryParams, ['class' => 'dropdown-item' . ($currentSort == 'nombre_chofer' ? ' active' : ''), 'style' => 'padding: 8px 16px; font-family: "Varela Round", sans-serif;']) ?></li>
                    <li><?= Html::a('<i class="fas fa-arrow-down" style="margin-right: 10px; width: 16px;"></i>Z - A', ['index', 'sort' => '-nombre_chofer'] + Yii::$app->request->queryParams, ['class' => 'dropdown-item' . ($currentSort == '-nombre_chofer' ? ' active' : ''), 'style' => 'padding: 8px 16px; font-family: "Varela Round", sans-serif;']) ?></li>
