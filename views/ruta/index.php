...
<div class="ruta-index">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 15px;">
        <div style="display: flex; gap: 10px; align-items: center;">
            <?php
            $sortCycle = [
                '' => ['label' => 'Ordenar por...', 'icon' => 'fa-sort', 'next' => 'id_ruta'],
                'id_ruta' => ['label' => 'ID ↑', 'icon' => 'fa-arrow-up-1-9', 'next' => '-id_ruta'],
                '-id_ruta' => ['label' => 'ID ↓', 'icon' => 'fa-arrow-down-9-1', 'next' => 'nombre_ruta'],
                'nombre_ruta' => ['label' => 'Nombre (A-Z)', 'icon' => 'fa-arrow-up-a-z', 'next' => '-nombre_ruta'],
                '-nombre_ruta' => ['label' => 'Nombre (Z-A)', 'icon' => 'fa-arrow-down-z-a', 'next' => ''],
            ];
